...
3.a Open Services -> IAM -> Users -> Create new Users. Enter `openhab` to _User names_, keep _Generate an access key for each user_ checked, and finally click _Create_.
3.b. _Show User Security Credentials_ and record the keys displayed
4. **Configure user policy to have access for dynamodb**
4.a. Open Services -> IAM -> Policies
4.b. Check _AmazonDynamoDBFullAccess_ and click _Policy actions_ -> _Attach_
4.c. Check the user created in step 2 and click _Attach policy_
