...
* [Syntax](#syntax)
	...
	* [Item type](#item-type)
		* [Dimmers vs Switches](#dimmers-vs-switches) 
		* [Group](#group)
	* [Item name](#item-name)
...
Dimmer | Accepts percent values to set the dimmed state. Can also be used as a switch by accepting ON/OFF commands (though this only mimics a Switch by sending 0% and 100% for ON/OFF. See 'Dimmers vs Switches' note below  | OnOff, Percent | OnOff, IncreaseDecrease, Percent
